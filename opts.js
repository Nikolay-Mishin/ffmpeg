...
export const getReportInfo = async (type, copy = true, i = {}) => {
    const { i: input, o, setFFmpeg, report, reportFile, logFile, logStr, mkvReport, s, ext, aCodecs, aCodecsOut, w, h, params } = i;
    ...
    if (setReport) {
        ...
        if (s) {
            await appendFile(reportFile, !setFFmpeg ? '' : `[res] ${w}x${h}, ${params ? 'params' : 'no-params'}\n`);
